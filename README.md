...
More details on the methodology can be found [here](https://syncandshare.lrz.de/getlink/fiDpiWqiBDsPwfbmvVWq8W/OSMNetFusion_2024_08_30.pdf). This is an example of the intial network (dark blue) and the resulting network (light blue) with the merged tags:
